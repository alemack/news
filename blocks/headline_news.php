                            ...
                            <div class="d-flex justify-content-center py-3">
                                <ul class="nav nav-pills">
                                    <li class="nav-item">
                                        ...
                                        <button style="border:0; background: rgb(234, 236, 239);"
                                            type="submit" name="id_favorites_headline" value=<?=$i?>>
                                        <a href="#" class="nav-link" aria-current="page">
                                            <svg xmlns="../img/star.svg" width="30" height="30" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">
